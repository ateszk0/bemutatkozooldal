...
const animateOnScroll = () => {
    const elements = document.querySelectorAll('.hero-title, .hero-subtitle, .cta-btn, .image-wrapper');
...
window.addEventListener('load', () => {
    ...
    document.querySelector('.hero-title').style.transform = 'translateY(20px)';
    ...
    document.querySelector('.image-wrapper').style.transform = 'scale(0.9)';
...
const animateOnScroll = () => {
    const elements = document.querySelectorAll('.about-content, .project-card, .category-card, .info-card, .contact-form');
...
// Set initial state for animation
window.addEventListener('load', () => {
    const animateElements = document.querySelectorAll('.about-content, .project-card, .category-card, .info-card, .contact-form');
